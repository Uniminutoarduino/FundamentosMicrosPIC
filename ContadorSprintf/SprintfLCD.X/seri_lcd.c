...
i2c_writeNBytes(pcf_adres, writeBuffer, 3);      
//i2c_write1ByteRegister(pcf_adres, writeBuffer[0], NULL);
//i2c_write1ByteRegister(pcf_adres, writeBuffer[1], NULL);
//i2c_write1ByteRegister(pcf_adres, writeBuffer[2], NULL);
...
/*******************************************************************************
 *  creates special characters on the screen.                               *
 * Sample:
 * char heart[8]={
 * 0b00000,
 * 0b01010,
