 ...
 * File:   main.c
 * Author: Jonathan
 * Este código permite configurar dos pulsadores de entrada para hacer una función de activar dos salidas
 * Created on 10 de marzo de 2025, 02:41 PM
 */
...
#define PulsON PORTBbits.RB2

void main(void) {
    
    //Condifguracion de pines
    ANSELB = 0; //Los pines RB2 y RB3 seran entradas digitales, RB0 y RB1 seran salidas
    TRISB = 0b00001100; //RB0 y RB1 como salidas, RB2 y RB3 como entradas
    asm("nop");//NOP
    
    //Limpiar pines RB0 y RB1
    PORTBbits.RB0 = 0;
    asm("nop");
    PORTBbits.RB1 = 0;
    asm("nop");
