 ...
 * Author: User
 *
 * Created on 11 de marzo de 2025, 2:49 p.m.
 */
...
void main(void) {
    ...
    ANSELB = 0;
    TRISB = 0b00000011;
    INTCON2bits.nRBPU = 0; //Habilitar resistencias de PullUp
    WPUBbits.WPUB0 = 1; //Resistencias de Pull up WPUB0 y WPUB1 activadas
    WPUBbits.WPUB1 = 1;
    asm("nop");
    ...
    while(1){
        ...
        if(PORTBbits.RB0 == 0 && PORTBbits.RB1 == 1){//Si se presiono RB0
            PORTBbits.RB2 = 1;
            asm("nop");
            PORTBbits.RB3 = 1;
            asm("nop");
        ...
        if(PORTBbits.RB0 == 1 && PORTBbits.RB1 == 0){//Si se presiono RB0
            PORTBbits.RB2 = 0;
            asm("nop");
            PORTBbits.RB3 = 0;
            asm("nop");
